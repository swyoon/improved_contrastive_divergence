...
from torchvision.transforms import RandomApply, ColorJitter, RandomChoice, RandomRotation, RandomResizedCrop
...
class ColorJitterSimCLR:
    def __init__(self, jitter_d=0.5, jitter_p=0.8):
        ...
        self.t = RandomApply([ColorJitter(0.8 * jitter_d, 0.8 * jitter_d, 0.8 * jitter_d, 0.4 * jitter_d)],
                             p=jitter_p)
...
class RandomApplyRandomResizedCrop(RandomResizedCrop):
