    ...
    def __init__(
        ...
        **kwargs
        ...
        if _designate_ids is None:
            ...
            temp_file_name = os.path.join(
                default_save_dir,
                f'{machine}_{split_type}_{"_".join(_designate_ids)}.pt'
            )
...
def compute_auc_per_wav_per_id(model, dl_wav_per_id, device, max_fpr=0.1, return_score=False, return_only_score=False):
    """
    model: nn.Module
